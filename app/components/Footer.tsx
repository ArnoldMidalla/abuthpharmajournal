      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm opacity-90">
              <p><a href="#" className="hover:text-accent transition-colors">Quick submissions</a></p>
              <p><a href="#" className="hover:text-accent transition-colors">Research and publication ethics</a></p>
              <p><a href="#" className="hover:text-accent transition-colors">Editorial boards</a></p>
              <p><a href="#" className="hover:text-accent transition-colors">submission system track your submissions</a></p>
            </div>
          </div>
        </div>
